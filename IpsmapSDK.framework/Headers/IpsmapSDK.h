...
//! Project version string for IpsmapSDK.
FOUNDATION_EXPORT const unsigned char IpsmapSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <IpsmapSDK/PublicHeader.h>
